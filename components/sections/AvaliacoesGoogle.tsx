...
function ReviewAvatar({ photoUrl, name }: { photoUrl?: string; name: string }) {
  ...
  if (!photoUrl || imgError) {
    return (
      <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full border-2 border-primary/30 bg-primary/15 font-display text-base font-bold text-primary shadow-sm">
...
export function AvaliacoesGoogle() {
  ...
  return (
    <section id="avaliacoes" className="relative border-t border-line/60 py-24 sm:py-32 bg-surface2/30 overflow-hidden">
      ...
      {/* Carrossel Horizontal Infinito Auto-Scroll */}
      <div className="relative w-full overflow-hidden">
        ...
        >
          {marqueeReviews.map((review: GoogleReview, idx: number) => (
            ...
            >
              <div>
                {/* Linha do Autor com componente de Avatar seguro */}
